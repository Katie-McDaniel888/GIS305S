...
def extract():
    ...
    r.encoding= "utf-8"
    data = r.text
    with open(r"C:\Users\ka003737\Downloads\addresses.csv", "w") as output_file:
        output_file.write(data)

def transform():
    print("Add City, State")
    transformed_file = open(r"C:\Users\ka003737\Downloads\addresses.csv", "w")
    transformed_file.write("X,Y,Type\n")
    with open(r"C:\Users\ka003737\Downloads\addresses.csv", "r") as partial_file:
        csv_dict = csv.DictReader(partial_file, delimiter=',')
        for row in csv_dict:
            address = row["Street Address"] + "Boulder CO"
            print(address)
            geocode_url = "https://geocoding.geo.census.goc/geocoders/locations/onlineaddress?address="+address+"\&benchmark=2020&format=json"
...
def load():
    ...
    in_table = r"C:\Users\ka003737\Downloads\new_addresses.csv"
